...
public class LoginActivityTest {
    ...
    private final static int BOTH_FIELDS_ID = -1;
    ...
    @Test
    public void whenBothFiedsAreFilled_andClickOnLoginButton_shouldOpenMainActivity(){
        Intents.init();

        onView(withId(R.id.login_username)).perform(typeText("defaultText"));
        closeSoftKeyboard();
        onView(withId(R.id.login_password)).perform(typeText("defaultText"));
        closeSoftKeyboard();
